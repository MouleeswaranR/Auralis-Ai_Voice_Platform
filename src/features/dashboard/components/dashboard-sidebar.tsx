                    ...
                    {items.map((item)=>(
                        <SidebarMenuItem key={item.title}>
                            ...
                            isActive={
                                item.url
                                ?item.url==="/"
                                ?pathname==="/":pathname.startsWith(item.url):false
                            }
                            onClick={
                                item.onClick
                            }
                            ...
                            tooltip={item.title}
                            className="h-9 px-3 py-2 text-[13px]
                            tracking-tight font-medium border border-transparent data-[active=true]:border-border
...
export function DashboardSidebar(){
    ...
    const otherMenuItems: MenuItem[]=[
        ...
        },
        {
            ...
            url:"mailto:www.ffmouleesh@gmail.com",
            icon: Headphones,
        },
    ];
                ...
                <SidebarMenu>
                    <SidebarMenuItem>
                        ...
                        fallback={
                            ...
                            group-data-[collapsible=icon]:size-8 rounded-md border border-border bg-white"
                            />
                        }
                        appearance={{
                            elements:{
